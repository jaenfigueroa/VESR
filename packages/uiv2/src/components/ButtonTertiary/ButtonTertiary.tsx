...
export const ButtonTertiary = ({text, color}: Props) => {
  return (
    <button className={ `vers-bg-${color} vers-text-white vers-py-[.2rem] vers-px-[.5rem] vers-rounded-full  vers-flex vers-justify-center sm:vers-justify-between vers-items-center vers-gap-4`}>
